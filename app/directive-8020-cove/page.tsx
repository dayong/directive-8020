...
import type { CoveContent } from '@/types/content-pages';

const SLUG = 'directive-8020-cove';

const content: CoveContent = (() => {
  const c = getPageContent<CoveContent>(SLUG);
      ...
      <div className="max-w-3xl mx-auto px-4 py-12 mdx-content">
        ...
        <section className="mt-12 pt-8 border-t border-slate-800">
          <h2 className="text-xl font-bold text-slate-100 mb-4">
            {content.quickAnswers.heading}
          </h2>
          <div className="space-y-3">
            {content.quickAnswers.items.map((item, i) => (
